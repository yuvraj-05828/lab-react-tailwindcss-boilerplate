...
***NOTE:*** You don't have to be exact with colors, but try to be as close as possible. The main aim of this lab is to make you practice and experiment around `TailwindCss` -> so free feel to experiment and make the webpage more fancy or beutiful.
